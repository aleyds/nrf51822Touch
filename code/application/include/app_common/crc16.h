...
uint16_t GetCRC16(uint8_t *pSource, uint32_t len);
uint16_t GetCRC16_Ext(uint8_t *pSource, uint32_t len,uint16_t *Iv);
uint8_t GetCRC8(uint8_t *pSource, uint16_t len);
