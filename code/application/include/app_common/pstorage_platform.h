...
#define BOOTLOADER_SIZE				(16) 														/**bootloader pase number**/
#define BOOTLOADER_ADDR				(0x3C000)
#define APP_ADDR					(0x16000)
#define APP_PAGE_SIZE				((BOOTLOADER_ADDR - APP_ADDR)/PSTORAGE_FLASH_PAGE_SIZE)

#define PSTORAGE_FLASH_PAGE_END     (NRF_FICR->CODESIZE  - BOOTLOADER_SIZE)
