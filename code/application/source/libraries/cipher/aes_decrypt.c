...
/**@brief     decryptions handler function for the value encryption
 *
 * @warning   This handler is an example only and does not fit a final product. You need to analyze
 *            how your product is supposed to react in case of error.
 *
 * @param[in] aes_key        Pointer to the encryption key.
 * @param[in] counter               Pointer to the random number.
 * @param[in] value                 Pointer to the value of encryption. 
 * @param[in] air_data              Pointer to the  encrypted value.
 */
uint8_t decryptions(uint8_t *air_data,uint8_t *aes_key,uint8_t *value)
{
